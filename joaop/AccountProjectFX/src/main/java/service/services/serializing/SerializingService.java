...
public final class SerializingService {
    ...
    private static <B extends Bean> void logBeanSerializingProcess
            ...
            throws IOException, InvalidArgumentException, PropertyNotFoundException, URISyntaxException {
        ...
        Files.write(Paths.get("./src/main/java/model/repository/serializing/logs/BeanSerializing.txt"),
